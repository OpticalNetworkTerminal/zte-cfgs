...
需要分别在 PyPI 和 TestPyPI 配置 publisher：

| 平台 | Project name | GitHub Environment | Workflow |
| --- | --- | --- | --- |
| PyPI | `zte-cfgs` | `pypi` | `.github/workflows/publish.yml` |
| TestPyPI | `zte-cfgs` | `testpypi` | `.github/workflows/publish.yml` |
